package com.hamtary.shopapp.ui.Auth
...
import com.hamtary.shopapp.databinding.FragmentLoginBinding
import com.hamtary.shopapp.models.UserInfo
import com.hamtary.shopapp.utils.EventObserver
import com.hamtary.shopapp.utils.snackbar
...
//    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    ...
    private fun saveEmailAndPassword(userEmail: String, userPassword: String, token: String, latLng: LatLng) {
        lifecycleScope.launch {
    ...
    private fun updateUserToken(userEmail: String, userPassword: String, userToken: String, latLng: LatLng) {
        authViewModel.setUserINfo(
            UserInfo(
                userEmail,
                userPassword,
    ...
    private fun login() {
        authViewModel.loginUser(binding.inputTextLayoutEmail, binding.inputTextLayoutPassword,)
    }
