...
import com.hamtary.shopapp.databinding.FragmentCategoryProductsBinding
...
class CategoryProductsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_categoryProductsFragment_to_productDetailsFragment, bundle)
        }
