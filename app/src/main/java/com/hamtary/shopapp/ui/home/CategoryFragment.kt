...
import com.hamtary.shopapp.adapters.CategoryAdapter2
import com.hamtary.shopapp.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        categoryAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_categoryFragment_to_categoryProductsFragment, bundle)
        }
    }
